...
export default function LandingPage() {
  ...
  const dashboardPath = profile ? `/${profile.role}/dashboard` : "/login";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans selection:bg-red-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-[#180a0a]/95 backdrop-blur border-b border-white/5 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-white/80 font-medium">
            <a href="#intro" className="hover:text-red-500 transition-colors">
              Giới thiệu
            </a>
            <a href="#courses" className="hover:text-red-500 transition-colors">
              Khóa học
            </a>
            <a href="#classes" className="hover:text-red-500 transition-colors">
              Lịch học
            </a>
            ...
            <div className="lg:col-span-5 hidden lg:flex justify-center relative">
              <div className="w-80 h-80 rounded-3xl bg-gradient-to-br from-red-600/35 to-primary-900/50 p-0.5 shadow-2xl relative rotate-3 overflow-hidden group hover:rotate-1 transition-transform duration-500">
                ...
                <div className="absolute bottom-6 left-6 right-6 text-white">
                  <p className="text-xs uppercase tracking-wider text-red-400 font-bold mb-1">
                    HLV Chuyên Nghiệp
                  </p>
                  <p className="font-extrabold text-lg">
                    Đào tạo bài bản theo lộ trình quốc tế
                  </p>
                </div>
              </div>
            ...
            {[
              {
                ...
                desc: "Giáo trình đào tạo bài bản, chuẩn hóa từ cơ bản đến thi đấu",
              },
              {
                icon: Award,
                title: "HLV chuyên nghiệp",
                desc: "Đội ngũ giáo viên giàu kinh nghiệm, tận tâm hướng dẫn từng học viên",
              },
              {
                icon: Users,
                title: "Cộng đồng năng động",
                desc: "Giao lưu học hỏi cùng hàng trăm học viên yêu thích cầu lông",
              },
            ].map((feat, i) => (
              <div
                key={i}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-2 mb-10">
            ...
            <p className="text-gray-500 text-xs sm:text-sm">
              Lựa chọn chương trình đào tạo phù hợp nhất với nhu cầu của bạn
            </p>
          </div>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="animate-pulse h-48 bg-white rounded-2xl border border-gray-100"
                />
              ))}
            </div>
          ) : packages.length === 0 ? (
            <div className="bg-white rounded-2xl p-12 text-center border border-gray-200 shadow-sm max-w-md mx-auto">
              ...
              <p className="text-gray-500 text-sm font-medium">
                Hiện tại chưa có gói học nào được mở bán
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
      ...
      <section id="classes" className="py-16 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-2 mb-10">
            ...
            <p className="text-gray-500 text-xs sm:text-sm">
              Lịch học linh hoạt, chia theo trình độ từ cơ bản đến nâng cao
            </p>
          </div>
          ...
          {isLoading ? (
            ...
            <div className="bg-gray-50 rounded-2xl p-12 text-center border border-gray-100 max-w-md mx-auto">
              ...
              <p className="text-gray-500 text-sm font-medium">
                Hiện tại chưa có lớp học nào hoạt động công khai
              </p>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {classes.map((cls) => (
                <div
                  key={cls.id}
                  className="bg-gray-50 rounded-2xl p-5 border border-gray-100 hover:border-red-200 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4"
                >
                  <div className="space-y-2 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`text-[10px] px-2 py-0.5 rounded-full font-medium border ${SKILL_LABELS[cls.skill_level]?.className}`}
                      >
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      {cls.schedule_days.map((d) => (
                        <span
                          key={d}
                          className="text-[10px] px-2 py-0.5 bg-red-50 text-red-600 rounded-md font-bold"
                        >
                          {DAY_LABELS[d] ?? d}
                        </span>
                      ))}
      ...
      <section
        id="contact"
        className="py-16 bg-gradient-to-br from-[#180a0a] to-[#2b1010] text-white"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-6 space-y-6">
              ...
              <p className="text-sm text-white/60 leading-relaxed max-w-md">
                Phụ huynh và học viên có nhu cầu đăng ký học thử, kiểm tra trình
                độ xếp lớp, vui lòng liên hệ trực tiếp với Thái Phong Badminton
                Class để được hỗ trợ tốt nhất.
              </p>
      ...
      <footer className="bg-[#110707] py-6 border-t border-white/5 text-white/40 text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p>
            © {new Date().getFullYear()} Thái Phong Badminton Class. All rights
            reserved.
          </p>
