...
export function Sidebar() {
  ...
  const { sidebarOpen, setSidebarOpen, setProfileDialogOpen } = useAppStore()
    ...
    <div className="flex flex-col h-full" style={{ background: '#180a0a' }}>
      ...
      <div className="px-3 pb-4 pt-2 border-t border-white/10 space-y-1">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-left hover:bg-white/5 transition-colors border-0 bg-transparent cursor-pointer"
        >
          {profile.avatar_url ? (
            <img
